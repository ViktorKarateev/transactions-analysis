...
def calculate_cashback(transactions: pd.DataFrame, year: int, month: int, cashback_rate: float = 0.01) -> dict:
    """
    ...
    :return: Словарь с кешбэком по категориям
    """
    ...
    return cashback.to_dict()  # Возвращаем обычный словарь
